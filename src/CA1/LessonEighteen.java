...
public class LessonEighteen{
	...
	public static void addThreadsToPool(){
		...
		eventPool.scheduleAtFixedRate(new PerformSystemCheck("Mail"), 0, 1, NANOSECONDS);
				
		eventPool.scheduleAtFixedRate(new PerformSystemCheck("Calendar"), 0, 1, NANOSECONDS);
